...
Last update: 2026-09-06 (S00 baseline; see `docs/baseline/baseline-report.md`).
...
| OS | Python | Status | Evidence |
|---|---|---|---|
| Linux x86-64 | 3.11–3.13 | unverified | GUI not yet built (S04–S06) |
| macOS Apple Silicon | 3.11–3.13 | unverified | |
| Windows x86-64 | 3.11–3.13 | unverified | |
