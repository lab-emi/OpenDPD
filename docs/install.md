...
[Use the hosted Studio](https://opendpd.com/studio/) without installation, or run OpenDPD **2.2.7** locally. Python 3.12 is the recommended starting point; the compute suite also covers 3.10–3.13.
...
```sh
python -m pip install "opendpd==2.2.7"
opendpd gui
```
